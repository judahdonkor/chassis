...
public class Enumeration {
	...
	private final static Map<Class<? extends Enum<?>>, Map<String, Map<?, Enum<?>>>> map = new HashMap<Class<? extends Enum<?>>, Map<String, Map<?, Enum<?>>>>();
	...
	public static <T extends Enum<T>> T valueOf(Class<T> enumType, Comparable<T> comparable) {
		...
		throw new IllegalArgumentException("No enum const " + enumType + "." + comparable);
	}
	...
	public static <T> String toString(T enumObj) {
